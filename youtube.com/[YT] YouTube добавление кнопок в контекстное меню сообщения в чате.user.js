...
// @author          Zerody (https://github.com/zerodytrash) / Fork: luk1337 (https://github.com/luk1337) / Адаптация: NightWolf69 (https://github.com/NightWolf69)
...
var main = function() {
    ...
    var appendAdditionalChannelContextItems = function(reqUrl, response) {
        ...
        mainMenuRendererNode.menuRenderer.items.unshift(generateMenuLinkItem("https://socialblade.com/youtube/channel/" + mappedChannel.channelId, "Socialblade О канале", "MONETIZATION_ON"));

        // append social blade statistic shortcut
        mainMenuRendererNode.menuRenderer.items.unshift(generateMenuLinkItem("https://playboard.co/en/channel/" + mappedChannel.channelId, "PlayBoard О канале", "INSIGHTS"));

        // append visit channel menu item
        mainMenuRendererNode.menuRenderer.items.unshift(generateMenuLinkItem("/channel/" + mappedChannel.channelId, "Перейти на канал", "ACCOUNT_CIRCLE"));
